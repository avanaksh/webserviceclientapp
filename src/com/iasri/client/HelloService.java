 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.iasri.com/", wsdlLocation = "http://localhost:9089/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.iasri.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9089/hellows?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.iasri.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.iasri.com/", "HelloPort"), Hello.class, features);
    }
