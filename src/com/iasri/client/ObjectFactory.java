 ...
 * generated in the com.iasri.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Greeting_QNAME = new QName("http://ws.iasri.com/", "greeting");
    private final static QName _GreetingResponse_QNAME = new QName("http://ws.iasri.com/", "greetingResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.iasri.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.iasri.com/", name = "greeting")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.iasri.com/", name = "greetingResponse")
